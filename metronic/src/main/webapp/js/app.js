                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            'metronic/assets/admin/pages/scripts/index3.js',
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            'metronic/assets/global/plugins/angularjs/plugins/angular-file-upload/angular-file-upload.min.js',
                        ] 
                    }, {
                        name: 'MetronicApp',
                        files: [
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            'metronic/assets/global/plugins/angularjs/plugins/ui-select/select.min.css',
                            'metronic/assets/global/plugins/angularjs/plugins/ui-select/select.min.js'
                        ] 
                    }, {
                        name: 'MetronicApp',
                        files: [
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                        files: [
                            'metronic/assets/global/plugins/jstree/dist/themes/default/style.min.css',

                            'metronic/assets/global/plugins/jstree/dist/jstree.min.js',
                            'metronic/assets/admin/pages/scripts/ui-tree.js',
                            'js/controllers/GeneralPageController.js'
                        ] 
                    }]);
                }] 
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        files: [
                            ...
                            'metronic/assets/global/plugins/jquery-tags-input/jquery.tagsinput.css',
                            'metronic/assets/global/plugins/bootstrap-markdown/css/bootstrap-markdown.min.css',
                            'metronic/assets/global/plugins/typeahead/typeahead.css',

                            'metronic/assets/global/plugins/fuelux/js/spinner.min.js',
                            ...
                            'metronic/assets/global/plugins/jquery.input-ip-address-control-1.0.min.js',
                            'metronic/assets/global/plugins/bootstrap-pwstrength/pwstrength-bootstrap.min.js',
                            'metronic/assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js',
                            'metronic/assets/global/plugins/jquery-tags-input/jquery.tagsinput.min.js',
                            'metronic/assets/global/plugins/bootstrap-maxlength/bootstrap-maxlength.min.js',
                            'metronic/assets/global/plugins/bootstrap-touchspin/bootstrap.touchspin.js',
                            ...
                            'metronic/assets/admin/pages/scripts/components-form-tools.js',
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                        files: [
                            'metronic/assets/global/plugins/clockface/css/clockface.css',
                            ...
                            'metronic/assets/global/plugins/bootstrap-colorpicker/css/colorpicker.css',
                            ...
                            'metronic/assets/global/plugins/clockface/js/clockface.js',
                            'metronic/assets/global/plugins/bootstrap-daterangepicker/moment.min.js',
                            'metronic/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.js',
                            'metronic/assets/global/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js',
                            'metronic/assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js',

                            'metronic/assets/admin/pages/scripts/components-pickers.js',
            ...
            resolve: {
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([{
                        ...
                        insertBefore: '#ng_load_plugins_before', // load the above css files before '#ng_load_plugins_before'
                        files: [
                            'metronic/assets/global/plugins/bootstrap-select/bootstrap-select.min.css',
                            ...
                            'metronic/assets/global/plugins/bootstrap-select/bootstrap-select.min.js',
                            ...
                            'metronic/assets/admin/pages/scripts/components-dropdowns.js',
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({
                        ...
                        files: [
                            ...
                            'metronic/assets/admin/pages/scripts/profile.js',
                ...
                deps: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load({ 
                        ...
                        files: [
                            ...
                            'metronic/assets/admin/pages/scripts/todo.js',
